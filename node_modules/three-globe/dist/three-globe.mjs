...
var GlowMesh = /*#__PURE__*/function (_THREE$Mesh) {
  function GlowMesh(geometry) {
    ...
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      lightDirection = _ref$lightDirection === void 0 ? [0, 0, 0] : _ref$lightDirection,
    ...
    var glowMaterial = createGlowMaterial(intensity, coefficient, color, power, hollowRadius, lightDirection);
...
var GlobeLayerKapsule = Kapsule({
  ...
  update: function update(state, changedProps) {
    ...
    if (['atmosphereColor', 'atmosphereAltitude', 'atmosphereIntensity', 'atmosphereDispersion', 'atmosphereDensity', 'atmosphereLightDirection'].some(function (prop) {
      return changedProps.hasOwnProperty(prop);
    })) {
...
var linkedGlobeLayerProps = Object.assign.apply(Object, _toConsumableArray(['globeImageUrl', 'bumpImageUrl', 'globeCurvatureResolution', 'globeTileEngineUrl', 'globeTileEngineMaxLevel', 'showGlobe', 'showGraticules', 'showAtmosphere', 'atmosphereColor', 'atmosphereAltitude', 'atmosphereIntensity', 'atmosphereDispersion', 'atmosphereDensity', 'atmosphereLightDirection'].map(function (p) {
